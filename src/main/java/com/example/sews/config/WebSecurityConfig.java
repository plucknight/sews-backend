...
//				.logout(lt -> lt.logoutSuccessHandler(loginLogoutSuccessHandler))
                ...
                .authorizeHttpRequests(authorizeHttpRequest -> authorizeHttpRequest
                        ...
                        .requestMatchers("/admin/login", "/map", "/prediction-results/getAll",
                                "warningRules/getAllWarningRules","monitoringPhoto/device").permitAll()
                        // 允许所有 OPTIONS 请求
                        .requestMatchers(HttpMethod.OPTIONS, "/**").permitAll()

                        .requestMatchers("/user/**", "/warning/getWarningInfo/count/**", "/monitoringPhoto/device/count/**", "/devices/deviceCount/**").hasRole("USER")

                        .requestMatchers("/devices/**", "/models/**", "/monitor/**", "/warning/**", "/warningRules/**", "/weather/getAllWeatherData", "/devicesMaintenance/**", "/monitoringPhoto/**", "/admin/username/**", "/admin/id", "/admin/userList").hasRole("ADMIN")
